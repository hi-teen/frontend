          ...
          >
            ...
            >
              <div className="flex items-center gap-1">
                <Image src="/heart.png" alt="like" width={compact ? 11 : 14} height={compact ? 11 : 14} />
                <span className={compact ? "" : "text-xs text-[#8D8D8D]"}>
                  {likes}
                </span>
              </div>
              <div className="flex items-center gap-1">
                <Image src="/bubble.png" alt="comment" width={compact ? 11 : 14} height={compact ? 11 : 14} />
                <span className={compact ? "" : "text-xs text-[#8D8D8D]"}>
                  {comments}
                </span>
              </div>
              <div className="flex items-center gap-1">
                <Image src="/eye.png" alt="view" width={compact ? 11 : 14} height={compact ? 11 : 14} />
                <span className={compact ? "" : "text-xs text-[#8D8D8D]"}>
                  {views}
                </span>
              </div>
